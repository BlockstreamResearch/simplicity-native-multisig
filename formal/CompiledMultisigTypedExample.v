...
From MultisigFormal Require Export CompiledMultisigTypedExampleData.
From MultisigFormal Require Import
  BridgeTypeTranslation CmrWellFormed SimplicityByteDecoder TypedBridge
  MultisigCertificate MultisigTypedCertificate CompiledMultisigByteData.
...
Example compiled_multisig_typed_certificate_expands :
...
Definition compiled_multisig_streaming_typed_decoded_program : option StructuralProgram :=
...
Theorem compiled_multisig_streaming_typed_decode_evidence :
  exists program,
...
Example compiled_multisig_compact_typed_certificate_bytes :
  compact_typed_certificate_bytes compiled_multisig_compact_typed_certificate =
    compiled_multisig_certificate.
Proof.
  reflexivity.
Qed.
...
Theorem compiled_multisig_streaming_typed_bridge_evidence_if_checked :
...
Proof.
  intros alg base_hooks program Hchecked.
  rewrite <- compiled_multisig_compact_typed_certificate_bytes.
  eapply
