...
\begin{document}
  ...
  The confirmation payload contains the participant index, the participant's x-only public key, the
  descriptor itself, and a BIP-340 signature over the message:
  ...
  Both mulitisg joining confirmation announcements (magic \texttt{SIMPANNC}) and vote proposals (magic \texttt{SIMPVOTE}) use the same chunked record framing.
